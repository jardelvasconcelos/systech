        ...
        <main>
            <section className="container-sobre">
                <div className="container-item-sobre">
                    ...
                    Fundada em 2023 por Luiz Fernando , engenheiro elétrico que se dedicou a conhecer profundamente uma área de grande expansão, a robótica.
            ...
            <section className="container-solucoes">
                <div className="container-item-sobre">
                    ...
                    <h3 className="item-sobre-subtitle">
                        Somos especializados em fornecer soluções de manutenção para máquinas e equipamentos robóticos em diversas indústrias.
